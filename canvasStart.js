...
module.exports = class CanvasStart {
   ...
   draw(canvas, postdata, stringpostdata, debug, id) {
      ...
      Utilities.drawRectangle(ctx, 0, null, null, "rgb(255, 255, 255)", 0, 0, canvas.width, canvas.height, 0, false, false, false, false, false);
      ...
      if (titleArr.length > 0) {
         ...
         let titletmd = TextMetadata.getTextMetadataFromObject(this.working, this.working.postdata.title, this.working.postdata.params.title, TextMetadata.getDefaultTmd());
         let titleParams = {};
      ...
      if (versionArr.length > 0) {
         ...
         let versiontmd = TextMetadata.getTextMetadataFromObject(this.working, this.working.postdata.version, this.working.postdata.params.version, TextMetadata.getDefaultTmd());
         let versionParams = {};
      ...
      if (descriptionArr.length > 0) {
         ...
         let descriptiontmd = TextMetadata.getTextMetadataFromObject(this.working, this.working.postdata.description, this.working.postdata.params.description, TextMetadata.getDefaultTmd());
      ...
      if (Utilities.isString(stringpostdata)) {
         ...
         xy = Utilities.drawTextRectangle(ctx, stringpostdata, tmccl, xy.y + this.working.globalSpacing, this.working.globalSpacing, null, null, null, false, false, false, false, false, undefined, this.working.tags);
         this.working.manageMaxWidthXy(xy);
      }
      ...
      if (this.working.maxWidth > canvas.width || this.working.maxHeight > canvas.height) {
         ...
         this.working.logDebug("==== Canvas too small - resizing from " + oldCanvasWidth + "x" + oldCanvasHeight + " to " + canvas.width + "x" + canvas.height);
         return this.draw(canvas, postdata, stringpostdata, debug, id);
      } else {
