  ...
  [
    {
      ...
      comment:
        [
          ...
          "<code> ...",
          "",
          "Note that a parameter defined tag just inserts the alias markup into the specific string of text, and will",
          "remain in force in that string until otherwise changed. So <code>&lt;code&gt; here will run until the end of the line.",
